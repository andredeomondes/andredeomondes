...
```typescript
{ estudando: ["TypeScript", "NestJS", "Next.js", "Jest"], curso: "Full Stack Club" }
```
...
| [Finance App API](https://github.com/andredeomondes/finance-app-api) | [Cadastro de Ninjas](https://github.com/andredeomondes/CadastroDeNinjas) | [Stay Hard CLI](https://github.com/andredeomondes/stay-hard-v1-cli) | [Game2D](https://github.com/andredeomondes/game2d_alien) |
|---|---|---|---|
| TypeScript + Jest | Spring Boot API | Java CLI | Python Game |
